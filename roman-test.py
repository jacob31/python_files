...
class ToRomanBadInput(unittest.TestCase):
    ...
    def test_zero(self):
        ''' to_roman should fail with zero as input '''
        self.assertRaises(roman.OutOfRangeError, roman.to_roman, 0)

    def test_negative(self):
        ''' to_roman should fail with negative integer input '''
        self.assertRaises(roman.OutOfRangeError, roman.to_roman, -1)

    def test_non_integer(self):
        ''' to_roman should fail with decimal input '''
...
class FromRomanBadInput(unittest.TestCase):
    def test_too_many_repeated_numerals(self):
        ...
        for s in ('MMMM', 'DD', 'CCCC', 'LL', 'XXXX', 'IIII'):
