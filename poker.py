...
# created: 6/6/2016 to in-process
# class: Design of Computer Programs, by Udacity
# purpose: poker program that ranks which hand wins
# 
...
def allmax(iterable, key=None):
    ...
    top_hand = max(hands, key = hand_rank)
    all_items = []
